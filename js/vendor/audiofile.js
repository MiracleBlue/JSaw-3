...
AudioFile.prototype.decode = function(cb) {
...
MP3Decoder.prototype.decode = function(data) {

    throw('MP3Decoder not implemented');

    /*

    var mp3 = new Mad.MP3File(data),
...
WAVDecoder.prototype.decode = function(data) {
    ...
    decoded.channels = channels;
    decoded.length = length;
    console.log(length, sampleRate, length / sampleRate);
    return decoded;
};
